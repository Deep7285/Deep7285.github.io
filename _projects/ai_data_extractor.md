...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/data_extractor_1.png" alt="Data Extractor UI" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/data_extractor_2.png" alt="Extracted Results View" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
