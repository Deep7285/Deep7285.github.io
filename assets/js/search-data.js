    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/fsw_gpr_surrogate/";
            },},{id: "projects-geocalc",
          title: 'GeoCalc',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/porodet/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%65%65%70%61%6B%37%32%38%35%35@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Deep7285", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/deepak8439", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0003-0160-0630", "_blank");
        },
      },{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Deepak_Kumar_CV.pdf", "_blank");
        },
      },{
      id: 'light-theme',
